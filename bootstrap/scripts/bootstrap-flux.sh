...
#   CLUSTER_NAME, CLUSTER_SG_ID, CLUSTER_ADMIN_ROLE_ARN, ADMIN_ROLE_ARN,
#   READONLY_ROLE_ARN, GHCR_PTC_SECRET_ARN, ACK_CAPABILITY_ROLE_ARN,
#   ACCOUNT_ID, VPC_ID, WEBHOOK_SG_ID, REGION, PROW_IMAGES_REPO_NAME,
#   PROW_IMAGES_REPO_URI, PROW_IMAGE_REPO, PROW_LOGS_BUCKET, PROW_DOMAIN,
#   TEST_INFRA_ORG, TEST_INFRA_REPO, TEST_INFRA_BRANCH, FLUX_VERSION
set -euo pipefail
...
data:
  ...
  ACK_CAPABILITY_ROLE_ARN: "${ACK_CAPABILITY_ROLE_ARN}"
  ACCOUNT_ID: "${ACCOUNT_ID}"
  VPC_ID: "${VPC_ID}"
  WEBHOOK_SG_ID: "${WEBHOOK_SG_ID}"
  REGION: "${REGION}"
  PROW_IMAGES_REPO_NAME: "${PROW_IMAGES_REPO_NAME}"
  PROW_IMAGES_REPO_URI: "${PROW_IMAGES_REPO_URI}"
  PROW_IMAGE_REPO: "${PROW_IMAGE_REPO}"
  PROW_LOGS_BUCKET: "${PROW_LOGS_BUCKET}"
