...
default:
  labels:
    ...
    - color: e11d21
      description: Indicates that a PR generated by an agent was unhelpful or required a large rework.
      name: agent/unhelpful
      target: prs
      addedBy: reviewers or members
    - color: 15dd18
      description: Indicates that a PR generated by an agent was helpful. Agent generated code may have required some feedback, but was mostly or fully correct.
      name: agent/helpful
      target: prs
      addedBy: reviewers or members
