...
def save_operations_catalog(operations_catalog: Dict[str, List[str]], service: str, resource: str) -> str:
    ...
    Args:
        operations_catalog: Dictionary with exactly these 5 keys:
            - create_operations: List of operations that create the resource
            - read_operations: List of operations that read the resource  
            - update_operations: List of operations that update the resource
            - delete_operations: List of operations that delete the resource
