...
export class ProwServiceAccounts extends cdk.Construct {
  ...
  constructor(scope: cdk.Construct, id: string, props: ProwServiceAccountsProps) {
    super(scope, id);
    ...
    this.deploymentServiceAccount.addToPrincipalPolicy(tideStatusReconcilerAccessPolicy);
    ...
    this.presubmitJobServiceAccount = props.prowCluster.addServiceAccount('PreSubmitJobServiceAccount', {
    ...
    this.postsubmitJobServiceAccount = props.prowCluster.addServiceAccount('PostSubmitJobServiceAccount', {
      namespace: PROW_JOB_NAMESPACE,
