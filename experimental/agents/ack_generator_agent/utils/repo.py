...
"""Repository utility functions for ACK Generator tools."""
...
def ensure_code_generator_cloned() -> str:
    ...
    # else:
    #     print("Code generator exists, pulling latest changes...")
    #     repo = Repo(settings.code_generator_path)
...
def ensure_runtime_cloned() -> str:
    ...
    # else:
    #     print("Runtime exists, pulling latest changes...")
    #     repo = Repo(settings.runtime_path)
    #     origin = repo.remotes.origin
    #     safe_pull(origin)
...
def ensure_aws_sdk_go_v2_cloned() -> str:
    ...
    # else:
    #     print("aws-sdk-go-v2 exists, pulling latest changes...")
    #     repo = Repo(settings.aws_sdk_go_v2_path)
    #     origin = repo.remotes.origin
    #     safe_pull(origin)
...
def ensure_service_repo_cloned(service: str) -> str:
    ...
    # else:
    #     print(f"Updating {service} controller repository...")
    #     repo = Repo(service_path)
    #     origin = repo.remotes.origin
    #     safe_pull(origin)
